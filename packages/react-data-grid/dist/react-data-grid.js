...
/***/ (function(module, exports, __webpack_require__) {
	...
	var HeaderCell = function (_React$Component) {
	  ...
	  HeaderCell.prototype.render = function render() {
	    ...
	    return React.createElement(
	      'div',
	      { className: className, style: this.getStyle(), 'data-column': this.props.column.id || this.props.column.key },
	      cell,
	      resizeHandle
	    );
	  };
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Row = function (_React$Component2) {
	  ...
	  Row.prototype.render = function render() {
	    ...
	    return React.createElement(
	      'div',
	      _extends({}, this.getKnownDivProps(), { className: className, style: style, onDragEnter: this.handleDragEnter, 'data-row': this.props.idx }),
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _initialiseProps = function _initialiseProps() {
	  ...
	  this.deselectCells = function () {
	    _this3.setState({ selected: { rowIdx: -1, idx: -1 } });
	  };

	  this.deselectRows = function () {
	    var selectedRows = [];
	    for (var i = 0; i < _this3.state.selectedRows; i++) {
	      if (rowsToDeselect.indexOf(_this3.state.selectedRows[i].id) === -1) {
	        selectedRows.push(_this3.state.selectedRows[i]);
	      } else {
	        selectedRows.push(Object.assign({}, _this3.state.selectedRows[i], { isSelected: false }));
	      }
	    }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _initialiseProps = function _initialiseProps() {
	  ...
	  this.getInitialValue = function () {
	    ...
	    return _typeof(_this2.props.value) === 'object' ? _this2.props.value : undefined;
	  };
